...
/* interface */
typedef struct ThreadPoolInterface {
    ThreadPool* (*pfNew)(int minThreadNum, int maxThreadNum, int maxTaskQueueLen);
    int (*pfDelete)(ThreadPool* pstPool);
    int (*pfAddTask)(ThreadPool* pstPool, void* (*pfExecute)(void* pvArg), void* pvArg);
    int (*pfAddTaskWithLock)(ThreadPool* pstPool, void* (*pfExecute)(void* pvArg), void* pvArg);
    int (*pfStart)(ThreadPool* pstPool);
    int (*pfStop)(ThreadPool* pstPool);
    int (*pfShutdown)(ThreadPool* pstPool);
    int (*pfGetTaskNum)(ThreadPool* pstPool);
    int (*pfGetLock)(ThreadPool* pstPool, pthread_mutex_t** pstLock);
